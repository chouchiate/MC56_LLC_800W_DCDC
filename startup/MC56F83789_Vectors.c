/******************************************************************************************
    MC56F83789 startup code, default ISR and vector table for use with DSC compiler
...
#if 1
    /* If USB clock is not enabled, the system hangs when access the USB register
     * in debug window. So enable the USB clock by default. */
...
/******************* Default ISR for QSCI2_RERR **********************/
/* Double weak ISR mechanism for QSCI2_RERR to facilitate SDK usage. */

/* User could redefine the QSCI2_RERR_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void QSCI2_RERR_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_QSCI2_RERR.
Please be noted that ivINT_QSCI2_RERR can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_QSCI2_RERR definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_QSCI2_RERR(void);
__attribute__((weak)) void ivINT_QSCI2_RERR(void)
{
    QSCI2_RERR_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/

/******************* Default ISR for QSCI2_RCV **********************/
/* Double weak ISR mechanism for QSCI2_RCV to facilitate SDK usage. */

/* User could redefine the QSCI2_RCV_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void QSCI2_RCV_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_QSCI2_RCV.
Please be noted that ivINT_QSCI2_RCV can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_QSCI2_RCV definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_QSCI2_RCV(void);
__attribute__((weak)) void ivINT_QSCI2_RCV(void)
{
    QSCI2_RCV_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/

/******************* Default ISR for QSCI2_TRIDLE **********************/
/* Double weak ISR mechanism for QSCI2_TRIDLE to facilitate SDK usage. */

/* User could redefine the QSCI2_TRIDLE_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void QSCI2_TRIDLE_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_QSCI2_TRIDLE.
Please be noted that ivINT_QSCI2_TRIDLE can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_QSCI2_TRIDLE definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_QSCI2_TRIDLE(void);
__attribute__((weak)) void ivINT_QSCI2_TRIDLE(void)
{
    QSCI2_TRIDLE_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/

/******************* Default ISR for QSCI2_TDRE **********************/
/* Double weak ISR mechanism for QSCI2_TDRE to facilitate SDK usage. */

/* User could redefine the QSCI2_TDRE_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void QSCI2_TDRE_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_QSCI2_TDRE.
Please be noted that ivINT_QSCI2_TDRE can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_QSCI2_TDRE definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_QSCI2_TDRE(void);
__attribute__((weak)) void ivINT_QSCI2_TDRE(void)
{
    QSCI2_TDRE_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/
...
/******************* Default ISR for QSPI1_XMIT **********************/
/* Double weak ISR mechanism for QSPI1_XMIT to facilitate SDK usage. */

/* User could redefine the QSPI1_XMIT_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void QSPI1_XMIT_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_QSPI1_XMIT.
Please be noted that ivINT_QSPI1_XMIT can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_QSPI1_XMIT definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_QSPI1_XMIT(void);
__attribute__((weak)) void ivINT_QSPI1_XMIT(void)
{
    QSPI1_XMIT_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/

/******************* Default ISR for QSPI1_RCV **********************/
/* Double weak ISR mechanism for QSPI1_RCV to facilitate SDK usage. */

/* User could redefine the QSPI1_RCV_DriverIRQHandler as normal function to implement their own ISR. */
__attribute__((weak)) static void QSPI1_RCV_DriverIRQHandler(void)
{
    default_interrupt();
}

/* User could redefine ivINT_QSPI1_RCV.
Please be noted that ivINT_QSPI1_RCV can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_QSPI1_RCV definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_QSPI1_RCV(void);
__attribute__((weak)) void ivINT_QSPI1_RCV(void)
{
    QSPI1_RCV_DriverIRQHandler();
}
#pragma interrupt off
/********************************************************************/
...
/* User could redefine ivINT_USB.
Please be noted that ivINT_USB can't be defined as normal function,
it should be protected by #pragma interrupt xxx, refer to below ivINT_USB definition. */
#pragma interrupt alignsp saveall
__attribute__((weak)) void ivINT_USB(void);
__attribute__((weak)) void ivINT_USB(void)
{
    default_interrupt();
}
...
volatile asm void _vect(void) {
    ...
    JSR >ivINT_QSCI2_TRIDLE       /* Interrupt no. 45*/
