...
- type_id: 'xbara_reg_1361a1ab61604bcef7903db46e437ee0'
...
static void XBARA_init(void) {
  /* XBARA control registers initialization */
#if defined(XBARA_CTRL0_INIT)
  XBARA->CTRL0 = XBARA_CTRL0_INIT;
#endif /* XBARA_CTRL0_INIT */
#if defined(XBARA_CTRL1_INIT)
  XBARA->CTRL1 = XBARA_CTRL1_INIT;
#endif /* XBARA_CTRL1_INIT */
}
...
- mode: 'dac_general'
- custom_name_enabled: 'false'
- type_id: 'dac_reg_826d5f280a25f7cdf5d84a53bf6614d6'
- functional_group: 'BOARD_InitPeripherals'
- peripheral: 'DACA'
- config_sets:
  - fsl_dac:
...
static void DACA_init(void) {
/****************************************************************************/
/* DACA initialization */
/****************************************************************************/
  /* Software reset DACA. */
  SIM->PSWR1 |= SIM_PSWR1_DACA_MASK;
  SIM->PSWR1 &= ~ SIM_PSWR1_DACA_MASK;
#if (DACA_CTRL0_INIT & DAC_CTRL0_FORMAT_MASK)
  DACA->CTRL0 |= DAC_CTRL0_FORMAT_MASK;
#endif /* DACA_CTRL0_INIT & DAC_CTRL0_FORMAT_MASK */
#if ((DACA_CTRL0_INIT & DAC_CTRL0_PDN_MASK) == 0U)
  DACA->CTRL0 &= ~DAC_CTRL0_PDN_MASK;
  SDK_DelayAtLeastUs(12, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);
#endif /* (DACA_CTRL0_INIT & DAC_CTRL0_PDN_MASK) == 0U */
#if defined(DACA_DATAREG_FMT0_INIT)
  DACA->FMT0.DATAREG_FMT0 = DACA_DATAREG_FMT0_INIT;
#endif /* DACA_DATAREG_FMT0_INIT */
#if defined(DACA_DATAREG_FMT1_INIT)
  DACA->FMT1.DATAREG_FMT1 = DACA_DATAREG_FMT1_INIT;
#endif /* DACA_DATAREG_FMT1_INIT */
#if defined(DACA_STEPVAL_FMT0_INIT)
  DACA->FMT0.STEPVAL_FMT0 = DACA_STEPVAL_FMT0_INIT;
#endif /* DACA_STEPVAL_FMT0_INIT */
#if defined(DACA_STEPVAL_FMT1_INIT)
  DACA->FMT1.STEPVAL_FMT1 = DACA_STEPVAL_FMT1_INIT;
#endif /* DACA_STEPVAL_FMT1_INIT */
#if defined(DACA_MINVAL_FMT0_INIT)
   DACA->FMT0.MINVAL_FMT0 = DACA_MINVAL_FMT0_INIT;
#endif /* DACA_MINVAL_FMT0_INIT */
#if defined(DACA_MINVAL_FMT1_INIT)
   DACA->FMT1.MINVAL_FMT1 = DACA_MINVAL_FMT1_INIT;
#endif /* DACA_MINVAL_FMT1_INIT */
#if defined(DACA_MAXVAL_FMT0_INIT)
  DACA->FMT0.MAXVAL_FMT0 = DACA_MAXVAL_FMT0_INIT;
#endif /* DACA_MAXVAL_FMT0_INIT */
#if defined(DACA_MAXVAL_FMT1_INIT)
  DACA->FMT1.MAXVAL_FMT1 = DACA_MAXVAL_FMT1_INIT;
#endif /* DACA_MAXVAL_FMT1_INIT */
#if defined(DACA_CTRL1_INIT)
  DACA->CTRL1 = DACA_CTRL1_INIT;
#endif /* DACA_CTRL1_INIT */
#if defined(DACA_COMPARE_INIT)
  DACA->COMPARE = DACA_COMPARE_INIT;
#endif /* DACA_COMPARE_INIT */
#if defined(DACA_CTRL0_INIT)
#if defined(DACA_FIRST_COUNT_DIR_MASK)
  DACA->CTRL0 = (DACA_CTRL0_INIT & ~(DACA_FIRST_COUNT_DIR_MASK));
#endif /* DACA_FIRST_COUNT_DIR_MASK */
  DACA->CTRL0 = DACA_CTRL0_INIT;
#endif /* DACA_CTRL0_INIT */

}

/***********************************************************************************************************************
 * DACB initialization code
 **********************************************************************************************************************/
/* clang-format off */
/* TEXT BELOW IS USED AS SETTING FOR TOOLS *************************************
instance:
...
/****************************************************************************/
  /* Software reset DACB. */
  SIM->PSWR1 |= SIM_PSWR1_DACB_MASK;
  SIM->PSWR1 &= ~ SIM_PSWR1_DACB_MASK;
#if (DACB_CTRL0_INIT & DAC_CTRL0_FORMAT_MASK)
  DACB->CTRL0 |= DAC_CTRL0_FORMAT_MASK;
#endif /* DACB_CTRL0_INIT & DAC_CTRL0_FORMAT_MASK */
#if ((DACB_CTRL0_INIT & DAC_CTRL0_PDN_MASK) == 0U)
  DACB->CTRL0 &= ~DAC_CTRL0_PDN_MASK;
  SDK_DelayAtLeastUs(12, SDK_DEVICE_MAXIMUM_CPU_CLOCK_FREQUENCY);
#endif /* (DACB_CTRL0_INIT & DAC_CTRL0_PDN_MASK) == 0U */
#if defined(DACB_DATAREG_FMT0_INIT)
  DACB->FMT0.DATAREG_FMT0 = DACB_DATAREG_FMT0_INIT;
#endif /* DACB_DATAREG_FMT0_INIT */
#if defined(DACB_DATAREG_FMT1_INIT)
  DACB->FMT1.DATAREG_FMT1 = DACB_DATAREG_FMT1_INIT;
#endif /* DACB_DATAREG_FMT1_INIT */
#if defined(DACB_STEPVAL_FMT0_INIT)
  DACB->FMT0.STEPVAL_FMT0 = DACB_STEPVAL_FMT0_INIT;
#endif /* DACB_STEPVAL_FMT0_INIT */
#if defined(DACB_STEPVAL_FMT1_INIT)
  DACB->FMT1.STEPVAL_FMT1 = DACB_STEPVAL_FMT1_INIT;
#endif /* DACB_STEPVAL_FMT1_INIT */
#if defined(DACB_MINVAL_FMT0_INIT)
   DACB->FMT0.MINVAL_FMT0 = DACB_MINVAL_FMT0_INIT;
#endif /* DACB_MINVAL_FMT0_INIT */
#if defined(DACB_MINVAL_FMT1_INIT)
   DACB->FMT1.MINVAL_FMT1 = DACB_MINVAL_FMT1_INIT;
#endif /* DACB_MINVAL_FMT1_INIT */
#if defined(DACB_MAXVAL_FMT0_INIT)
  DACB->FMT0.MAXVAL_FMT0 = DACB_MAXVAL_FMT0_INIT;
#endif /* DACB_MAXVAL_FMT0_INIT */
#if defined(DACB_MAXVAL_FMT1_INIT)
  DACB->FMT1.MAXVAL_FMT1 = DACB_MAXVAL_FMT1_INIT;
#endif /* DACB_MAXVAL_FMT1_INIT */
#if defined(DACB_CTRL1_INIT)
  DACB->CTRL1 = DACB_CTRL1_INIT;
#endif /* DACB_CTRL1_INIT */
#if defined(DACB_COMPARE_INIT)
  DACB->COMPARE = DACB_COMPARE_INIT;
#endif /* DACB_COMPARE_INIT */
#if defined(DACB_CTRL0_INIT)
#if defined(DACB_FIRST_COUNT_DIR_MASK)
  DACB->CTRL0 = (DACB_CTRL0_INIT & ~(DACB_FIRST_COUNT_DIR_MASK));
#endif /* DACB_FIRST_COUNT_DIR_MASK */
  DACB->CTRL0 = DACB_CTRL0_INIT;
#endif /* DACB_CTRL0_INIT */
...
- config_sets:
  ...
  - fsl_dac:
    ...
    - dac_config:
      ...
      - DACValue: '250'
  - interrupt:
    - interrupt_sel: 'kCMP_OutputRisingInterruptEnable'
    - enableDma: 'false'
    - enable_irq: 'true'
    - interrupt:
      - IRQn: 'kCMPB_VECTORn'
...
/****************************************************************************/
  /* Software peripheral reset to a known state. */
  SIM->PSWR1 |= SIM_PSWR1_IIC0_MASK;
  SIM->PSWR1 &= ~ SIM_PSWR1_IIC0_MASK;
#if defined(I2C0_A1_INIT)
  I2C0->A1 = I2C0_A1_INIT;
#endif /* I2C0_A1_INIT */
#if defined(I2C0_F_INIT)
  I2C0->F = I2C0_F_INIT;
#endif /* I2C0_F_INIT */
#if defined(I2C0_C2_INIT)
  I2C0->C2 = I2C0_C2_INIT;
#endif /* I2C0_C2_INIT */
#if defined(I2C0_FLT_INIT)
  I2C0->FLT = I2C0_FLT_INIT;
#endif /* I2C0_FLT_INIT */
#if defined(I2C0_RA_INIT)
  I2C0->RA = I2C0_RA_INIT;
#endif /* I2C0_RA_INIT */
#if defined(I2C0_SMB_INIT)
  I2C0->SMB = I2C0_SMB_INIT;
#endif /* I2C0_SMB_INIT */
#if defined(I2C0_A2_INIT)
  I2C0->A2 = I2C0_A2_INIT;
#endif /* I2C0_A2_INIT */
#if defined(I2C0_SLTH_INIT)
  I2C0->SLTH = I2C0_SLTH_INIT;
#endif /* I2C0_SLTH_INIT */
#if defined(I2C0_SLTL_INIT)
  I2C0->SLTL = I2C0_SLTL_INIT;
#endif /* I2C0_SLTL_INIT */
#if defined(I2C0_C1_INIT)
  I2C0->C1 = I2C0_C1_INIT;
#endif /* I2C0_C1_INIT */
}
...
- config_sets:
  - pit_reg:
    ...
    - slaveMode: 'false'
    - enableCounter: 'true'
    - enableRollOverInterruptSource: 'false'
    - enable_irq: 'false'
    - interrupt:
...
static void BOARD_InitPeripherals_CommonPreInit(void)
{
  ...
  /* Enable clock gate of the DACA peripheral. */
  SIM->PCE1 |= SIM_PCE1_DACA_MASK;
  /* Enable clock gate of the DACB peripheral. */
  SIM->PCE1 |= SIM_PCE1_DACB_MASK;
  ...
  /* Enable clock gate of the I2C0 peripheral. */
  SIM->PCE1 |= SIM_PCE1_IIC0_MASK;
...
static void BOARD_InitPeripherals_CommonPostInit(void)
{
  ...
  /* Set the interrupt priority: Priority 2 of the kCMPA_VECTORn request in the INTC. */
  INTC->IPR10 = (INTC->IPR10 & ~INTC_IPR10_CMPA_MASK) | INTC_IPR10_CMPA(3);
  /* Set the interrupt priority: Priority 2 of the kCMPB_VECTORn request in the INTC. */
  INTC->IPR10 = (INTC->IPR10 & ~INTC_IPR10_CMPB_MASK) | INTC_IPR10_CMPB(3);
