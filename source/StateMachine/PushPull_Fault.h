...
#ifndef _PUSHPULL_FAULT_H_
#define _PUSHPULL_FAULT_H_
...
/* Public Function -----------------------------------------------------------*/
extern void PushPull_StateMachine_FaultMain(void);
//extern void TurnOffAllGatePin(void);
//extern void DisabelOffAllPwm();


static inline void PushPull_StateMachine_FaultInner(void){}

static inline void PushPull_StateMachine_FaultOutter(void){
...
//  DisabelOffAllPwm();
  ChangeState(PUSHPULL_FAULT_LOCK_STATE);
}
#endif
