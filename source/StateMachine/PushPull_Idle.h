...
#ifndef _PUSHPULL_IDLE_H_
#define _PUSHPULL_IDLE_H_
...
/* Public Variable -----------------------------------------------------------*/
/* Public Function -----------------------------------------------------------*/
extern void PushPull_StateMachine_IdleMain(void);

static inline void PushPull_StateMachine_IdleInner(void){}

static inline void PushPull_StateMachine_IdleOutter(void){
  gCV_Ref = gVdc;
  ...
  if(gOnOffToggle){
    gOnOffToggle = 0;
    ChangeState(PUSHPULL_RUN_STATE);
  }
}
#endif
